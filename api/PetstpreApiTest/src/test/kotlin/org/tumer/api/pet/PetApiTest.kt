...
class PetApiTest : BaseTest() {
    ...
    fun `should update an existing pet`() {
        ...
        val response = petApi.updatePet(updatedPet)
    ...
    fun `should find pets by status`() {
        ...
        assertThat(pets.first().status).isEqualTo("available")
    }
    ...
    fun `should delete a pet`() {
        ...
        // Verify Deletion (Negative Test for Get)
