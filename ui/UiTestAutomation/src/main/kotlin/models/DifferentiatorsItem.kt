...
val initialDifferentiators = arrayOf(
    ...
    DifferentiatorsItem(
        ...
        image = "https://insiderone.com/assets/media/2025/11/Marketer.webp",
        text = """
            Insider One keeps you ahead with the most complete
            AI-native customer engagement platform, fueled by the
            world’s most ambitious product roadmap, built to move
            faster than the market. Always first. Always forward.
        """.trimIndent()
    ),
    DifferentiatorsItem(
        title = "The three promises that set us apart\nBe first\nBe focused",
        ...
        text = """
            The Insider One Advantage™ delivers an unparalleled
            vendor experience from white-glove migration to rapid
            onboarding, reducing total cost of ownership, and
            accelerating time to value. Break free from everything
            that holds you back.
        """.trimIndent()
    ),
    DifferentiatorsItem(
